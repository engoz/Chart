...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return OurDataFeed; });\n/* harmony import */ var _history__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./history */ \"./src/history.js\");\n/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper */ \"./src/helper.js\");\n/* harmony import */ var _stream__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stream */ \"./src/stream.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\n\nvar OurDataFeed = /*#__PURE__*/function () {\n  function OurDataFeed() {\n    _classCallCheck(this, OurDataFeed);\n  }\n\n  _createClass(OurDataFeed, [{\n    key: \"onReady\",\n    value: function onReady(cb) {\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== onReady call ====\", false);\n      setTimeout(function () {\n        return cb(_helper__WEBPACK_IMPORTED_MODULE_1__[\"ourConfig\"]);\n      }, 0);\n    }\n  }, {\n    key: \"searchSymbols\",\n    value: function searchSymbols(userInput, exchange, symbolType, onResultReadyCallback) {\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== searchSymbols call ====\", false); // console.log(' Search Symbols :' + userInput);\n      // console.log(' Exchange = ' + exchange);\n      // console.log(' SymbolType = ' + symbolType);\n\n      var newSeymbols = _helper__WEBPACK_IMPORTED_MODULE_1__[\"ourSymbols\"].filter(function (symbol) {\n        var isFullSymbolContainsInput = symbol.full_name.toLowerCase().indexOf(userInput.toLowerCase()) !== -1;\n        return isFullSymbolContainsInput;\n      });\n      setTimeout(function () {\n        onResultReadyCallback(newSeymbols);\n      }, 0);\n    }\n  }, {\n    key: \"resolveSymbol\",\n    value: function resolveSymbol(symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {\n      var sym = _helper__WEBPACK_IMPORTED_MODULE_1__[\"findSymbol\"](symbolName);\n      var symbol_stub = {\n        name: sym.symbol,\n        ticker: sym.ticker,\n        format: 'price',\n        description: sym.description,\n        type: 'Currency',\n        session: '24x7',\n        timezone: 'Europe/Istanbul',\n        exchange: 'Arbitrage',\n        minmov: 1,\n        pricescale: 100000,\n        //dynamic\n        has_no_volume: true,\n        supports_time: true,\n        //has_weekly_and_monthly: false,\n        minmov2: 0,\n        //    fractional: false,\n        has_intraday: true,\n        //intraday_multipliers: ['1','60'],\n        supported_resolution: _helper__WEBPACK_IMPORTED_MODULE_1__[\"supportedResolutions\"],\n        has_seconds: false,\n        seconds_multipliers: [],\n        has_daily: true,\n        has_weekly_and_monthly: true,\n        //   has_empty_bars : false,\n        //   force_session_rebuild : true,\n        //   has_no_volume : false,\n        volume_precision: 5,\n        //dynamic\n        data_status: \"streaming\",\n        //    expired: true,\n        //    expiration_date : 0,\n        //     sector : \"fff s\",\n        currency_code: \"TRY\"\n      };\n      setTimeout(function () {\n        onSymbolResolvedCallback(symbol_stub);\n      }, 0);\n      setTimeout(function () {\n        onResolveErrorCallback();\n      }, 0);\n    }\n  }, {\n    key: \"getBars\",\n    value: function getBars(symbolInfo, resolution, from, to, onHistoryCallback, onErrorCallback, firstDataRequest) {\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== getBars call ====\", false);\n      _history__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getBars(symbolInfo, resolution, from, to, firstDataRequest).then(function (bars) {\n        if (bars != null) {\n          onHistoryCallback(bars, {\n            noData: false\n          });\n        } else {\n          onHistoryCallback(bars, {\n            noData: true\n          });\n        }\n      })[\"catch\"](function (err) {\n        return console.log('Hata');\n      });\n    }\n  }, {\n    key: \"subscribeBars\",\n    value: function subscribeBars(symbolInfo, resolution, onRealtimeCallback, subscribeUID, onResetCacheNeededCallback) {\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== subscribeBars ====\", false);\n      Object(_stream__WEBPACK_IMPORTED_MODULE_2__[\"subscribeOnStream\"])(symbolInfo, resolution, onRealtimeCallback, subscribeUID, onResetCacheNeededCallback);\n    }\n  }, {\n    key: \"unsubscribeBars\",\n    value: function unsubscribeBars(subscriberUID) {\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== unsubscribeBars ====\", false);\n      Object(_stream__WEBPACK_IMPORTED_MODULE_2__[\"unsubscribeFromStream\"])(subscriberUID);\n    }\n  }, {\n    key: \"calculateHistoryDepth\",\n    value: function calculateHistoryDepth(resolution, resolutionBack, intervalBack) {\n      //optional\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== calculateHistoryDepth ====\", false);\n      return resolution < 60 ? {\n        resolutionBack: 'D',\n        intervalBack: '1'\n      } : undefined;\n    }\n  }, {\n    key: \"getMarks\",\n    value: function getMarks(symbolInfo, startDate, endDate, onDataCallback, resolution) {\n      //optional\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== getMarks ====\", false);\n    }\n  }, {\n    key: \"getTimeScaleMarks\",\n    value: function getTimeScaleMarks(symbolInfo, startDate, endDate, onDataCallback, resolution) {\n      //optional\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== getTimeScaleMarks ====\", false);\n    }\n  }, {\n    key: \"getServerTime\",\n    value: function getServerTime(cb) {\n      _helper__WEBPACK_IMPORTED_MODULE_1__[\"consoloYaz\"](\"==== getServerTime \" + cb, false);\n    }\n  }]);\n\n  return OurDataFeed;\n}();\n\n\n;\n\n//# sourceURL=webpack:///./src/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper */ \"./src/helper.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  history: history,\n  getBars: function getBars(symbolInfo, resolution, from, to, first, limit) {\n    _helper__WEBPACK_IMPORTED_MODULE_0__[\"consoloYaz\"](\"==== **** GetBars cagrildi **** ====\", false);\n    return new Promise(function (resolve, reject) {\n      var productId = _helper__WEBPACK_IMPORTED_MODULE_0__[\"findProductId\"](symbolInfo.name);\n      var toDate = _helper__WEBPACK_IMPORTED_MODULE_0__[\"calculateTime\"](to);\n      var fromDate = _helper__WEBPACK_IMPORTED_MODULE_0__[\"calculateTime\"](from);\n      var days = 25;\n      var frequency = _helper__WEBPACK_IMPORTED_MODULE_0__[\"getFrequency\"](resolution);\n      var history_url = _helper__WEBPACK_IMPORTED_MODULE_0__[\"restUrl\"] + \"/\" + productId + \"/chartData/\" + frequency + \"/\" + 100;\n      var headers = new Headers();\n      headers.append('Content-Type', 'text/json');\n      headers.append('username', _helper__WEBPACK_IMPORTED_MODULE_0__[\"username\"]);\n      fetch(history_url, {\n        method: 'GET',\n        headers: headers\n      }).then(function (response) {\n        return response.json();\n      }).then(function (data) {\n        if (data && data === 'undefined') {\n          console.error('Arbitarage Error');\n          return [];\n        }\n\n        if (data.length > 0) {\n          var bars = data.map(function (bar) {\n            //\tif (bar.time >= from && bar.time < to) {\n            var b = {\n              time: _helper__WEBPACK_IMPORTED_MODULE_0__[\"calculateTime\"](bar.chartData.updateTime),\n              low: (bar.chartData.lowAsk + bar.chartData.lowBid) / 2,\n              high: (bar.chartData.highAsk + bar.chartData.highBid) / 2,\n              open: (bar.chartData.openAsk + bar.chartData.openBid) / 2,\n              close: (bar.chartData.closeAsk + bar.chartData.closeBid) / 2,\n              volume: 0\n            };\n            return b; //\t}\n          });\n\n          if (first) {\n            var lastBar = bars[bars.length - 1];\n            history[symbolInfo.name] = {\n              lastBar: lastBar\n            };\n          }\n\n          resolve(bars);\n        } else {\n          resolve([]);\n        }\n      })[\"catch\"](function (err) {\n        return reject(err);\n      });\n    });\n  }\n});\n\n//# sourceURL=webpack:///./src/history.js?");
